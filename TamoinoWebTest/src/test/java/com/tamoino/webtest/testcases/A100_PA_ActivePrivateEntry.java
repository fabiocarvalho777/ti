...
public class A100_PA_ActivePrivateEntry extends TamoinoTestCase implements TestInput {
	...
	public void test() throws Exception {
		...
		click(PA1_NEW_PRIVATE_KEY, Constants.Checkbox._ACTIVE_ENTRY_CHECKBOX);
